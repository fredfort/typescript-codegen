...
export const DefaultApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        updateProduct(id: string, body?: Product, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteProduct(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ProductId> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).deleteProduct(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getProducts(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<Product>> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).getProducts(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        updateProduct(id: string, body?: Product, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Product> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).updateProduct(id, body, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const DefaultApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        deleteProduct(id: string, options?: any) {
            return DefaultApiFp(configuration).deleteProduct(id, options)(fetch, basePath);
        },
        /**
         * 
         * @param {*} [options] Override http request option.
         ...
         * @throws {RequiredError}
         */
        updateProduct(id: string, body?: Product, options?: any) {
            return DefaultApiFp(configuration).updateProduct(id, body, options)(fetch, basePath);
        },
    };
};
...
export class DefaultApi extends BaseAPI {
    ...
    public deleteProduct(id: string, options?: any) {
        return DefaultApiFp(this.configuration).deleteProduct(id, options)(this.fetch, this.basePath);
    }
    ...
    public getProducts(options?: any) {
        return DefaultApiFp(this.configuration).getProducts(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof DefaultApi
     */
    public updateProduct(id: string, body?: Product, options?: any) {
        return DefaultApiFp(this.configuration).updateProduct(id, body, options)(this.fetch, this.basePath);
    }
